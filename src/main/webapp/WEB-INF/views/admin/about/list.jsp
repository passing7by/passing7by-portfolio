	...
	<div class="card">
		<div class="card-body">
			<div class="card-title row m-0 justify-content-between">
				...
				<div class="row m-0">
					<a class="btn btn-primary m-b-30 mr-2" href="/${adminUrl }/about/add">등록</a>
							...
							<c:when test="${not empty list }">
								<c:forEach items="${list }" var="vo">
									<tr>
										...
										<th>${vo.rowNumber }</th>
										<td><a href="/${adminUrl }/about/detail?id=${vo.id }">${vo.title }</a></td>
										<td>${vo.formattedRegDate }</td>
										<td>${not empty vo.modDate ? vo.formattedModDate : '-' }</td>
